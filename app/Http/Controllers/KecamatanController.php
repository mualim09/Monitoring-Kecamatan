...
class KecamatanController extends Controller
{
        ...
        if ($validator->fails()) {
            ...
            if ($request->hasFile('gambar')) {
                ...
                if ($kecamatan) {
                    ...
                    return redirect()->route('kecamatan.index')->with('errors', 'Gagal menambahkan data kecamatan!');
                }
            }
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($deleted) {
            ...
            return redirect()->route('kecamatan.index')->with('errors', 'Gagal menghapus data kecamatan!');
        }
    }
}
