                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Nama
                                                Kecamatan</label>
                                            <input name="nama_kecamatan" value="{{ $kecamatan->nama_kecamatan }}"
                                                type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $kecamatan->luas_wilayah }}" name="luas_wilayah" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $kecamatan->nama_camat }}" name="nama_camat" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $kecamatan->jumlah_penduduk }}" name="jumlah_penduduk"
                                                type="text"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-3">
                                            ...
                                            <textarea name="deskripsi"
                                                ...
                                                rows="3"> {{ $kecamatan->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="lat" value="{{ $kecamatan->lat }}" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $kecamatan->longi }}" name="longi" type="text"
...
@push('map-script')
    <script>
        var mymap = L.map('mapid').setView([{{ $kecamatan->lat }}, {{ $kecamatan->longi }}],
            9);
        ...
        let marker = L.marker([{{ $kecamatan->lat }}, {{ $kecamatan->longi }}],
            option).addTo(mymap);
